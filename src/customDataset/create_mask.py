...
annotationFolder = os.path.abspath(os.path.join(script_dir, "./../DataSets/ChoroidSegmentation/annotation"))
...
with open(annotationFolder + "/via_export_json (4).json") as f:
